...
public class XmlParserTest extends TestCase
{
    ...
    public void testbooleanExact() throws Exception
    {

        is = new ByteArrayInputStream("<cmdline><boolean/></cmdline>".getBytes());
        ...
        assertEquals("<cmdline><boolean/></cmdline>", XmlParser.unparseTokens(cmd.allArgs()));

    }

    public void testbooleanVerbose() throws Exception
    {
    ...
    public void testEmbeddedLevelArray() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-kmy", "-tbegin-khello-m1", "-tInteger-kmoon", "-tInteger-kworld", "-tend-khello",
                "-tend-kmy");
        cmd.parse(XmlParser.getInstance(is));
    ...
    public void testNamespace2() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-ka", "-tbegin-kb-m1", "-tString-kz-c", "-tString-kx-c", "-tbegin-kc", "-tString-kd-m1",
                "-tend-kc", "-tend-kb", "-tend-ka");
        cmd.parse(XmlParser.getInstance(is));
    ...
    public void testNamespacePos2Changes() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-ka", "-tbegin-kb", "-tString-kc", "-tend-kb", "-tbegin-kd", "-tString-kz", "-tend-kd",
                "-tend-ka");
        cmd.parse(XmlParser.getInstance(is));
    ...
    public void testNamespacePos2twiceb() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-ka", "-tbegin-kb--pos-m1", "-tbegin-kc", "-tString-kd-m1--pos", "-tend-kc", "-tend-kb",
                "-tend-ka");
        cmd.parse(XmlParser.getInstance(is));

        assertEquals("-a[ [-c[ 'alpha' 'omega']]]", CommandLineParser.unparseTokens(cmd.allArgs()));
        assertEquals("<cmdline><a><noname><c><noname>alpha</noname><noname>omega</noname></c></noname></a></cmdline>",
                XmlParser
                        .unparseTokens(cmd.allArgs()));
    }
    ...
    public void testNamespacePos4twiceb() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd
                .compile("-tbegin-ka", "-tbegin-kb", "-tbegin-kc-m1", "-tString-kd--pos", "-tend-kc", "-tend-kb",
                        "-tend-ka");
        cmd.parse(XmlParser.getInstance(is));

        assertEquals("-a[-b[-c[ 'alpha'] [ 'omega']]]", CommandLineParser.unparseTokens(cmd.allArgs()));
        assertEquals("<cmdline><a><b><c><noname>alpha</noname></c><c><noname>omega</noname></c></b></a></cmdline>",
                XmlParser
                        .unparseTokens(cmd.allArgs()));
    }
    ...
    public void testTopLevelArray2() throws Exception
    {
        ...
        assertEquals("<cmdline><hello><moon>1</moon><world>0</world></hello><hello><moon>2</moon></hello></cmdline>",
                XmlParser
                        .unparseTokens(cmd.allArgs()));
    }
    ...
    public void testTwoLevelArray() throws Exception
    {
        ...
        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-kmy-m1", "-tbegin-khello-m1", "-tInteger-kmoon", "-tInteger-kworld", "-tend-khello",
                "-tend-kmy");
        cmd.parse(XmlParser.getInstance(is));
    ...
    public void testTwoNamespaces() throws Exception
    {
        ...
        is = new ByteArrayInputStream(
                "<cmdline><a><b><c><d>alpha</d></c></b></a><hello moon='2' world='1'></hello></cmdline>"
                        .getBytes());

        final ICmdLine cmd = new CmdLine("");
        cmd.compile("-tbegin-ka", "-tbegin-kb", "-tbegin-kc", "-tString-kd-m1", "-tend-kc", "-tend-kb", "-tend-ka",
                "-tbegin-khello", "-tInteger-kmoon", "-tInteger-kworld", "-tend-khello");
        cmd.parse(XmlParser.getInstance(is));
